...
public class Facebook {
    ...
    private boolean validateServiceIntent(Context context, Intent intent) {
        ...
        return resolveService == null ? false : validateAppSignatureForPackage(context, resolveService.serviceInfo.packageName);
    }
    ...
    public boolean extendAccessToken(Context context, ServiceListener serviceListener) {
        ...
        return !validateServiceIntent(context, intent) ? false : context.bindService(intent, new TokenRefreshServiceConnection(context, serviceListener), 1);
    }
    ...
    public void setAccessExpiresIn(String str) {
        ...
        if (str != null) {
            setAccessExpires(str.equals(AppEventsConstants.EVENT_PARAM_VALUE_NO) ? 0 : System.currentTimeMillis() + (Long.parseLong(str) * 1000));
        }
    }
