...
public class ScrollingTabContainerView extends NineHorizontalScrollView implements OnItemSelectedListener {
    ...
    public static class TabView extends LinearLayout {
        ...
        public void update() {
            ...
            if (text != null) {
                if (this.mTextView == null) {
                    customView = new CapitalizingTextView(getContext(), null, C0247R.attr.actionBarTabTextStyle);
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0247R.styleable.SherlockActionBar, C0247R.attr.actionBarStyle, 0);
    ...
    private IcsSpinner createSpinner() {
        IcsSpinner icsSpinner = new IcsSpinner(getContext(), null, C0247R.attr.actionDropDownStyle);
    ...
    private IcsLinearLayout createTabLayout() {
        TabsLinearLayout tabsLinearLayout = (TabsLinearLayout) LayoutInflater.from(getContext()).inflate(C0247R.layout.abs__action_bar_tab_bar_view, null);
    ...
    private TabView createTabView(Tab tab, boolean z) {
        TabView tabView = (TabView) this.mInflater.inflate(C0247R.layout.abs__action_bar_tab, null);
