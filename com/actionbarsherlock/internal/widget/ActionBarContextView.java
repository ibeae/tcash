...
public class ActionBarContextView extends AbsActionBarView implements AnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0247R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockActionMode, i, 0);
        setBackgroundDrawable(obtainStyledAttributes.getDrawable(0));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(4, 0);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(3, 0);
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(2, 0);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0247R.layout.abs__action_bar_title_item, this);
    ...
    public void initForMode(final ActionMode actionMode) {
        if (this.mClose == null) {
            this.mClose = (NineLinearLayout) LayoutInflater.from(this.mContext).inflate(C0247R.layout.abs__action_mode_close_item, this, false);
            addView(this.mClose);
        } else if (this.mClose.getParent() == null) {
            addView(this.mClose);
        }
        this.mClose.findViewById(C0247R.id.abs__action_mode_close_button).setOnClickListener(new OnClickListener() {
