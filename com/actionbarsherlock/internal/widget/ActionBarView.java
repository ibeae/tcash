...
public class ActionBarView extends AbsActionBarView {
    ...
    private final OnClickListener mExpandedActionViewUpListener = new C02652();
    ...
    private final OnItemSelectedListener mNavItemSelectedListener = new C02641();
    ...
    private final OnClickListener mUpClickListener = new C02663();
    ...
    public static class HomeView extends FrameLayout {
        ...
        protected void onFinishInflate() {
            this.mUpView = findViewById(C0247R.id.abs__up);
            this.mIconView = (ImageView) findViewById(C0247R.id.abs__home);
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C02671();
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C02671 implements Creator<SavedState> {
            C02671() {
            }
    ...
    public ActionBarView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockActionBar, C0247R.attr.actionBarStyle, 0);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(14, C0247R.layout.abs__action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0247R.string.abs__action_bar_up_description));
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0247R.layout.abs__action_bar_title_item, this, false);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0247R.id.abs__action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0247R.id.abs__action_bar_subtitle);
            this.mTitleUpView = this.mTitleLayout.findViewById(C0247R.id.abs__up);
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0247R.id.abs__progress_circular);
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0247R.id.abs__progress_horizontal);
    ...
    public void setDisplayOptions(int i) {
        ...
        if (!this.mHomeLayout.isEnabled()) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0247R.string.abs__action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0247R.string.abs__action_bar_home_description));
        }
    }
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback callback) {
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0247R.id.abs__action_menu_presenter);
            ...
            if (this.mSplitActionBar) {
                ...
                this.mActionMenuPresenter.setExpandedActionViewsExclusive(ResourcesCompat.getResources_getBoolean(getContext(), C0247R.bool.abs__action_bar_expanded_action_views_exclusive));
                configPresenters(menuBuilder);
                actionMenuView = (ActionMenuView) this.mActionMenuPresenter.getMenuView(this);
                viewGroup2 = (ViewGroup) actionMenuView.getParent();
    ...
    public void setNavigationMode(int i) {
        ...
        if (i != i2) {
            ...
            switch (i) {
                case 1:
                    if (this.mSpinner == null) {
                        this.mSpinner = new IcsSpinner(this.mContext, null, C0247R.attr.actionDropDownStyle);
                        this.mListNavLayout = (IcsLinearLayout) LayoutInflater.from(this.mContext).inflate(C0247R.layout.abs__action_bar_tab_bar_view, null);
