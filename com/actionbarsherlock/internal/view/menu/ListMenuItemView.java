...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockMenuView, i, 0);
    ...
    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0247R.layout.abs__list_menu_item_checkbox, this, false);
        addView(this.mCheckBox);
    }

    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0247R.layout.abs__list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0247R.layout.abs__list_menu_item_radio, this, false);
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0247R.id.abs__title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0247R.id.abs__shortcut);
    }
