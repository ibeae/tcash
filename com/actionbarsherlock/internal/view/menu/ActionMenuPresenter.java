...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class OverflowMenuButton extends ImageButton implements View_HasStateListenerSupport, ActionMenuChildView {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0247R.layout.abs__action_menu_layout, C0247R.layout.abs__action_menu_item_layout);
    }
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(context, C0247R.integer.abs__max_action_buttons);
        }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(this.mContext, C0247R.integer.abs__max_action_buttons);
            if (this.mMenu != null) {
