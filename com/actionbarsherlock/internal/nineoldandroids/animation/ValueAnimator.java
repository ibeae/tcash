...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C02531();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C02553();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C02564();
    private static long sFrameDelay = 10;
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C02542();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C02575();
    ...
    static class C02531 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C02531() {
        }
    ...
    static class C02542 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C02542() {
        }
    ...
    static class C02553 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C02553() {
        }
    ...
    static class C02564 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C02564() {
        }
    ...
    static class C02575 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C02575() {
        }
