...
public class MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = MenuInflater.this.mContext.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockMenuGroup);
        ...
        public void readItem(AttributeSet attributeSet) {
            int i = 1;
            TypedArray obtainStyledAttributes = MenuInflater.this.mContext.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockMenuItem);
