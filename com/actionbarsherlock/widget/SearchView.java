...
import android.support.v4.widget.C0188a;
...
import com.actionbarsherlock.C0247R;
...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    private C0188a mSuggestionsAdapter;
    ...
    class C02854 implements OnFocusChangeListener {
        C02854() {
        }
    ...
    class C02865 implements OnLayoutChangeListener {
        C02865() {
        }
    ...
    class C02876 implements OnGlobalLayoutListener {
        C02876() {
        }
    ...
    class C02887 implements OnClickListener {
        C02887() {
        }
    ...
    class C02898 implements OnKeyListener {
        C02898() {
        }
        ...
        public boolean onKey(View view, int i, KeyEvent keyEvent) {
            ...
            if (SearchView.this.mQueryTextView.isEmpty() || !C0146g.m466a(keyEvent)) {
                return false;
            }
    ...
    class C02909 implements OnEditorActionListener {
        C02909() {
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mShowImeRunnable = new C02821();
        this.mUpdateDrawableStateRunnable = new C02832();
        this.mReleaseCursorRunnable = new C02843();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02887();
        this.mTextKeyListener = new C02898();
        this.mOnEditorActionListener = new C02909();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0247R.layout.abs__search_view, this, true);
        this.mSearchButton = findViewById(C0247R.id.abs__search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0247R.id.abs__search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0247R.id.abs__search_edit_frame);
        this.mSearchPlate = findViewById(C0247R.id.abs__search_plate);
        this.mSubmitArea = findViewById(C0247R.id.abs__submit_area);
        this.mSubmitButton = findViewById(C0247R.id.abs__search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0247R.id.abs__search_close_btn);
        this.mVoiceButton = findViewById(C0247R.id.abs__search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0247R.id.abs__search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C02854());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockSearchView, 0, 0);
        ...
        obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockView, 0, 0);
        ...
        if (this.mDropDownAnchor != null) {
            if (VERSION.SDK_INT >= 11) {
                this.mDropDownAnchor.addOnLayoutChangeListener(new C02865());
            } else {
                this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02876());
            }
        }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                dimensionPixelSize = resources.getDimensionPixelSize(C0247R.dimen.abs__dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0247R.dimen.abs__dropdownitem_icon_width);
            } else {
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0247R.dimen.abs__search_view_preferred_width);
    }

    private int getSearchIconId() {
        TypedValue typedValue = new TypedValue();
        getContext().getTheme().resolveAttribute(C0247R.attr.searchViewSearchIcon, typedValue, true);
    ...
    private boolean onSuggestionsKey(View view, int i, KeyEvent keyEvent) {
        if (this.mSearchable == null || this.mSuggestionsAdapter == null || keyEvent.getAction() != 0 || !C0146g.m466a(keyEvent)) {
            return false;
        }
        if (i == 66 || i == 84 || i == 61) {
    ...
    public C0188a getSuggestionsAdapter() {
    ...
    public void setSuggestionsAdapter(C0188a c0188a) {
        this.mSuggestionsAdapter = c0188a;
        this.mQueryTextView.setAdapter(this.mSuggestionsAdapter);
    }
}
