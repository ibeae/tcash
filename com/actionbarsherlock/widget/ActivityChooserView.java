...
class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02791 extends DataSetObserver {
        C02791() {
        }
    ...
    class C02802 implements OnGlobalLayoutListener {
        C02802() {
        }
    ...
    class C02813 extends DataSetObserver {
        C02813() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0247R.id.abs__list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0247R.layout.abs__activity_chooser_view_list_item, viewGroup, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.mContext.getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0247R.id.abs__icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                    ((TextView) view.findViewById(C0247R.id.abs__title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                case 1:
                    ...
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0247R.layout.abs__activity_chooser_view_list_item, viewGroup, false);
                    view.setId(1);
                    ((TextView) view.findViewById(C0247R.id.abs__title)).setText(ActivityChooserView.this.mContext.getString(C0247R.string.abs__activity_chooser_view_see_all));
                    return view;
                default:
                    throw new IllegalArgumentException();
            }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new C02791();
        this.mOnGlobalLayoutListener = new C02802();
        this.mInitialActivityCount = 4;
        this.mContext = context;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0247R.styleable.SherlockActivityChooserView, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(1, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(2);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(this.mContext).inflate(C0247R.layout.abs__activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (IcsLinearLayout) findViewById(C0247R.id.abs__activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0247R.id.abs__default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0247R.id.abs__image);
        this.mExpandActivityOverflowButton = (FrameLayout) findViewById(C0247R.id.abs__expand_activities_button);
        this.mExpandActivityOverflowButton.setOnClickListener(this.mCallbacks);
        this.mExpandActivityOverflowButtonImage = (ImageView) this.mExpandActivityOverflowButton.findViewById(C0247R.id.abs__image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(drawable);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C02813());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0247R.dimen.abs__config_prefDialogWidth));
    }
    ...
    private void showPopupUnchecked(int i) {
        ...
        if (!listPopupWindow.isShowing()) {
            ...
            listPopupWindow.getListView().setContentDescription(this.mContext.getString(C0247R.string.abs__activitychooserview_choose_application));
        }
    }
