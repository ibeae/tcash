...
import android.support.v4.widget.C0195e;
...
class SuggestionsAdapter extends C0195e implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0247R.id.edit_query);
        }
    }
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, ConstantState> weakHashMap) {
        super(context, C0247R.layout.abs__search_dropdown_item_icons_2line, null, true);
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0247R.attr.textColorSearchUrl, typedValue, true);
