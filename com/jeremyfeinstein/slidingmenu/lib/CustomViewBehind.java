...
public class CustomViewBehind extends ViewGroup {
    ...
    public void drawSelector(View view, Canvas canvas, float f) {
        if (this.mSelectorEnabled && this.mSelectorDrawable != null && this.mSelectedView != null && ((String) this.mSelectedView.getTag(C1211R.id.selected_view)).equals("CustomViewBehindSelectedView")) {
            canvas.save();
    ...
    public int getMenuPage(int i) {
        ...
        return (this.mMode != 0 || i <= 1) ? (this.mMode != 1 || i >= 1) ? i : 2 : 0;
    }
    ...
    public boolean marginTouchAllowed(View view, int i) {
        ...
        return this.mMode == 0 ? i >= left && i <= left + this.mMarginThreshold : this.mMode == 1 ? i <= right && i >= right - this.mMarginThreshold : this.mMode == 2 ? (i < left || i > left + this.mMarginThreshold) ? i <= right && i >= right - this.mMarginThreshold : true : false;
    }
    ...
    public boolean menuTouchInQuickReturn(View view, int i, float f) {
        return (this.mMode == 0 || (this.mMode == 2 && i == 0)) ? f >= ((float) view.getLeft()) : (this.mMode == 1 || (this.mMode == 2 && i == 2)) ? f <= ((float) view.getRight()) : false;
    }
    ...
    public void setSelectedView(View view) {
        if (this.mSelectedView != null) {
            this.mSelectedView.setTag(C1211R.id.selected_view, null);
            this.mSelectedView = null;
        }
        if (view != null && view.getParent() != null) {
            this.mSelectedView = view;
            this.mSelectedView.setTag(C1211R.id.selected_view, "CustomViewBehindSelectedView");
            invalidate();
        }
    }
