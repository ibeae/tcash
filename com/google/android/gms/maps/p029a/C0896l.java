...
public interface C0896l extends IInterface {

    public static abstract class C0898a extends Binder implements C0896l {

        private static class C0897a implements C0896l {
        ...
        public static C0896l m3159a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0896l)) ? new C0897a(iBinder) : (C0896l) queryLocalInterface;
        }
