...
public interface bx extends IInterface {
    ...
    public static abstract class C0708a extends Binder implements bx {

        private static class C0712a implements bx {
            private IBinder f1081a;
            ...
            public String mo933a() {
                ...
                try {
                    ...
                    this.f1081a.transact(1, obtain, obtain2, 0);
            ...
            public void mo934b(int i) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    obtain.writeInt(i);
                    this.f1081a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo935c(int i) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    obtain.writeInt(i);
                    this.f1081a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static bx m1755a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bx)) ? new C0712a(iBinder) : (bx) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    mo934b(parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    mo935c(parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
